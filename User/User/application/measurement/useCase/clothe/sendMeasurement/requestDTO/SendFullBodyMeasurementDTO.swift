...
struct FullBodyMeasurementDTO : RequestDataAble, MeasurementDataAble {
    
    let receivingUserId: String
    let sendingUserId: String
    let sentDate: String
    let measurementType = "fullBody"
    let measurement: FullBody
}


struct FullBody : Codable {
